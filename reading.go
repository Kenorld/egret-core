...
var (
	...
	DataReaders = map[string]DataReader{
		"application/x-www-form-urlencoded": &FormDataReader{},
		"multipart/form-data":               &FormDataReader{},
		"application/json":                  &JSONDataReader{},
		"application/xml":                   &XMLDataReader{},
		"text/xml":                          &XMLDataReader{},
	}
...
func (r *FormDataReader) Read(req *Request, data interface{}) error {
