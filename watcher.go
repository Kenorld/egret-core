...
func (w *Watcher) eagerRebuildEnabled() bool {
	return Config.GetBoolDefault("dev_mode", true) &&
		Config.GetBoolDefault("watch.enabled", true) &&
		Config.GetStringDefault("watch.mode", "normal") == "eager"
}
...
//WatchHandler
var WatchHandler = func(c *Context) {
	if MainWatcher != nil {
